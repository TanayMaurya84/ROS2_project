...
#include "nav2_msgs/action/navigate_to_pose.hpp" //nav2 component to move towards goal
...
public:
  ...
  // Action Client callback- to know if the target position has been achieved
